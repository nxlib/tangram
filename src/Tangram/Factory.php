...
class Factory
{
     ...
     * @param  Tangram             $composer
     * @param  Tangram             $globalComposer
     * @param  bool                 $disablePlugins
     *
     * @return Plugin\PluginManager
     */
    protected function createPluginManager(IOInterface $io, Tangram $composer, Tangram $globalComposer = null, $disablePlugins = false)
    {
     ...
     * @param IO\IOInterface                $io
     */
    protected function createDefaultInstallers(Installer\InstallationManager $im, Tangram $composer, IOInterface $io)
    {
